...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ScrollView rootView, @NonNull MaterialButton btnLogin,
      ...
      @NonNull ProgressBar progressBar, @NonNull TextView tvChangeServer,
    ...
    this.tvChangeServer = tvChangeServer;
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvChangeServer;
      TextView tvChangeServer = ViewBindings.findChildViewById(rootView, id);
      if (tvChangeServer == null) {
        break missingId;
      }
      ...
      return new ActivityLoginBinding((ScrollView) rootView, btnLogin, etPassword, etUsername,
          progressBar, tvChangeServer, tvError);
    }
