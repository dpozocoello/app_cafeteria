...
echo [3/3] Iniciando Servidor API en http://127.0.0.1:8192
echo.
echo Para ver la documentacion interactiva: http://127.0.0.1:8192/docs
echo Para detener el servidor: Presione Ctrl+C
echo.

python -m uvicorn app.main:app --reload --host 127.0.0.1 --port 8192
